            ...
            <div class="row">
                <div class="col-lg-5 col-md-6 col-sm-12 mx-auto">
                    <div class="login-register-cover">
                        ...
                        <form class="login-register text-start mt-20" action="{{ route('password.email') }}">
                            @csrf
                            ...
                            <div class="form-group">
                                <button class="btn btn-default hover-up w-100" type="submit" name="continue">Continue</button>
                            </div>
